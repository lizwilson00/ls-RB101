...
def tricky_method_two(a_string_param, an_array_param)
  a_string_param << 'rutabaga'
  puts "Inside method: #{a_string_param} ID is #{a_string_param.object_id}"
  an_array_param = ['pumpkins', 'rutabaga']
  puts "Inside method: #{an_array_param} ID is #{an_array_param.object_id}"
end

my_string = "pumpkins"
puts "Before method invocation: #{my_string} object_id is #{my_string.object_id}"
my_array = ["pumpkins"]
puts "Before method invocation: #{my_array} object_id is #{my_array.object_id}"
tricky_method_two(my_string, my_array)

puts "#{return_val}"

puts "My string looks like this now: #{my_string}"
puts "After method: #{my_string} ID is #{my_string.object_id}"
puts "My array looks like this now: #{my_array}"
puts "After method: #{my_array} ID is #{my_array.object_id}"
